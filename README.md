...
> Combine matching media queriries into one media query definition. Useful for CSS gnerated by LESS using nested media queries. Only useful if CSS is written mobile-first.
